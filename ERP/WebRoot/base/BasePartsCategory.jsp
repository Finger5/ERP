...
<script type="text/javascript" src="/ERP/js/jquery-1.7.2.min.js"></script>
				...
				.datagrid(
						{
							...
							selectOnCheck : true,
							checkOnSelect : false,
							url : '/ERP/servlet/GetBasePartsCategoryJsonServlet',
							columns : [ [
									{
										field : 'id',
										checkbox : true,
	...
	function delRow(code) {
		$.messager
				.confirm(
						...
						function(r) {
							if (r) {
								/*$.ajax({url:'/ERP/servlet/DeleteBasePartsCategoryServlet',
									data:{'code':code},
									type:'post',
									...
									for (i = 0; i < selRows.length; i++) {
										...
										$
												.ajax({
													type : 'post',
													async : false,
													url : '/ERP/servlet/DeleteBasePartsCategoryServlet',
													data : {
														'code' : code
													},
													success : function(data) {
