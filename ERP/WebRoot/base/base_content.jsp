...
function exportExcl(){
	...
	var name=$("input[name='name']").val();
	var categoryCode=$("select[name='categoryCode']").val();
	window.location.href="/ERP/excl/OutputExcelBaseContentServlet?code="+code+"&name="+name+"&categoryCode="+categoryCode;
}
...
function exportWord(){
	...
	window.location.href="/ERP/word/OutputWordBaseContentServlet?code="+code
...
<body>
    ...
    <div id="dg" style="padding:20px">
		<form name="frm" action="/ERP/BaseContent/UpdateBaseContentServlet" method="post" >
		...
		<input type="hidden" name="opt" />
			...
			<tr>
				<td class="td1">显示状态：</td><td><input name="isShow" type="radio" value="1" checked="checked"/>显示<input name="isShow" value="0" type="radio"/>隐藏</td>
